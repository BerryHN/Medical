#Image Background
image city = "images/first bg.jpg"
image w = "images/ward.jpeg"
image garage ="images/garage.png"
#image hospital='images/Uncle Mugen/hospital.jpg'
image ending = 'images/end.jpeg'
image happy dev ="images/happy dev.jpg"
image sad dev = 'images/sad dev.jpg'
image er_img = "images/ER_medium.jpg"
image football=im.Scale('images/soccer_field.jpg',800,600)
...
image layzee = 'images/layzee0001.png'
#image bont normalw = "images/oslor0001t.png"
image bolt ='images/bolt closed0001.png'
image bolt_f ='images/bolt open0001.png'
image Alice = 'images/Alice_normal0001.png'
image Alice angry = 'images/Alice_angry.png'

#Medical Images
image eye_n ='images/eye1.jpg'
image eye_enf ='images/eye2.jpg'
image eye_cured ='images/eye3.jpg'
image selected_LE ='images/Left selected.jpg'
image blood_back='Blood pressure back.png'
image pointer='images/needle.png'
