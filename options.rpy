...
init -1 python hide:
    ...
    config.window_title = u"Medical Dectective ver 2 Eng"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Medical Dectective ver 2 Eng"
...
python early:
    config.save_directory = "Medical Dectective ver 2 Eng-1413208418"
...
init python:
    ...
    build.directory_name = "MedicalDectectiveVer2Eng-1.0"
